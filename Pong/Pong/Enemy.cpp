...
namespace app
{
	namespace enemy
	{
		...
		void DrawEnemy()
		{
			...
			if (wave == First) DrawText("FIRST WAVE", GetScreenWidth() / 2 - MeasureText("FIRST WAVE", 40) / 2, GetScreenHeight() / 2 - 40, 40, Fade(RED, 0.1f));
			else if (wave == Second) DrawText("SECOND WAVE", GetScreenWidth() / 2 - MeasureText("SECOND WAVE", 40) / 2, GetScreenHeight() / 2 - 40, 40, Fade(RED, 0.2f));
			else if (wave == Third) DrawText("THIRD WAVE", GetScreenWidth() / 2 - MeasureText("THIRD WAVE", 40) / 2, GetScreenHeight() / 2 - 40, 40, Fade(RED, 0.3f));
		}
